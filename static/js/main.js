!(function(e) {
  ...
  function(e, t, r) {
    ...
    function s(e) {
      ...
      (this._75 = 0), (this._83 = 0), (this._18 = null), (this._38 = null), e !== n && y(e, this);
    }
    function u(e, t, r) {
      return new e.constructor(function(o, i) {
        var a = new s(n);
        a.then(o, i), f(e, new p(t, r, a));
      });
    }
    function f(e, t) {
      for (; 3 === e._83; ) e = e._18;
      if ((s._47 && s._47(e), 0 === e._83))
        return 0 === e._75
          ...
          : 1 === e._75 ? ((e._75 = 2), void (e._38 = [e._38, t])) : void e._38.push(t);
      c(e, t);
    }
    function c(e, t) {
      b(function() {
        var r = 1 === e._83 ? t.onFulfilled : t.onRejected;
        if (null === r) return void (1 === e._83 ? l(t.promise, e._18) : h(t.promise, e._18));
        var n = i(r, e._18);
        n === m ? h(t.promise, v) : l(t.promise, n);
      });
    }
    function l(e, t) {
      ...
      if (t && ('object' === typeof t || 'function' === typeof t)) {
        var r = o(t);
        if (r === m) return h(e, v);
        if (r === e.then && t instanceof s) return (e._83 = 3), (e._18 = t), void d(e);
    ...
    function d(e) {
      if ((1 === e._75 && (f(e, e._38), (e._38 = null)), 2 === e._75)) {
        for (var t = 0; t < e._38.length; t++) f(e, e._38[t]);
        e._38 = null;
      }
    }
    function p(e, t, r) {
  ...
  function(e, t, r) {
    'use strict';
    'undefined' === typeof Promise && (r(3).enable(), (window.Promise = r(6))),
      r(7),
      (Object.assign = r(8));
  },
  function(e, t, r) {
    'use strict';
    function n() {
      (f = !1), (s._47 = null), (s._71 = null);
    }
    function o(e) {
      function t(t) {
        (e.allRejections || a(l[t].error, e.whitelist || u)) &&
          ((l[t].displayId = c++),
          e.onUnhandled
      ...
      function r(t) {
        l[t].logged &&
          (e.onHandled
            ...
            : l[t].onUnhandled ||
              (console.warn('Promise Rejection Handled (id: ' + l[t].displayId + '):'),
              console.warn(
      ...
      (s._47 = function(e) {
        2 === e._83 &&
          l[e._56] &&
          (l[e._56].logged ? r(e._56) : clearTimeout(l[e._56].timeout), delete l[e._56]);
      }),
        (s._71 = function(e, r) {
          0 === e._75 &&
            ((e._56 = o++),
            (l[e._56] = {
              displayId: null,
              error: r,
              timeout: setTimeout(t.bind(null, e._56), a(r, u) ? 100 : 2e3),
              logged: !1
            }));
        });
    }
    ...
    (function(t) {
      ...
      function n() {
        for (; u < a.length; ) {
          var e = u;
          if (((u += 1), a[e].call(), u > f)) {
            for (var t = 0, r = a.length - u; t < r; t++) a[t] = a[t + u];
            (a.length -= u), (u = 0);
          }
        }
        (a.length = 0), (u = 0), (s = !1);
  ...
  function(e, t, r) {
    ...
    e.exports = (function() {
      ...
      ? Object.assign
      : function(e, t) {
          for (var r, s, u = n(e), f = 1; f < arguments.length; f++) {
  ...
  function(e, t, r) {
    ...
    function a(e) {
      e.forEach(function(e) {
        ...
        (y.globalAlpha = 0.1),
        y.beginPath(),
        y.moveTo(u(300), u(1e3)),
        y.lineTo(u(500), u(1e3)),
        y.lineTo(u(1e3), u(1e3)),
        (y.lineWidth = 0.5),
        (y.strokeStyle = f()),
        y.stroke(),
        y.restore(),
        ...
        e.nodeType)) {
          case 'fill':
            (y.globalAlpha = 0.3),
              e.props.fillStyle && (y.fillStyle = e.props.fillStyle),
              y.fillRect(e.props.x, e.props.y, e.props.width, e.props.height);
            break;
          case 'circle':
            e.props.fillStyle && (y.fillStyle = e.props.fillStyle), (y.globalAlpha = 0.3);
            var t = new Path2D();
            t.arc(e.props.x, e.props.y, e.props.width, e.props.height, 2 * Math.PI), y.fill(t);
        }
        if ((y.restore(), e.children))
    ...
    function s(e, t) {
      for (var r = arguments.length, n = Array(r > 2 ? r - 2 : 0), o = 2; o < r; o++)
        n[o - 2] = arguments[o];
      if (e.prototype instanceof b) {
        return new e(t, Array.from(n)).render();
      }
      return new b(e, t, Array.from(n));
    }
    function u(e) {
          ...
          h(e, [
            {
              key: 'setState',
              value: function(e) {
                (this.state = e(this.state)), this._render();
              }
            },
            {
              key: '_render',
            ...
            },
            {
              ...
              value: function() {
                (this.mounded = !0), this.componentDidMount();
              }
            },
      ...
      return (
        ...
        h(t, [
          ...
          },
          {
            key: 'render',
            value: function() {
              return v.createElement('fragment', null);
            }
          }
        ]),
        t
    ...
    })(v.createElement('container', null, v.createElement(m, null)));
  },
  function(e, t, r) {
    (function(e) {
      !(function(r, n) {
        var o = n();
        'object' === typeof e && e && e.exports && (t = e.exports = o), (t.randomColor = o);
      })(0, function() {
        function e(e) {
          var t = i(e.hue),
            r = u(t);
        ...
        function t(e, t) {
          ...
          if ('random' === t.luminosity) return u([0, 100]);
          var r = a(e),
            n = r[0],
            o = r[1];
          switch (t.luminosity) {
        ...
        function s(e) {
          ...
          for (var t in b) {
            var r = b[t];
            if (r.hueRange && e >= r.hueRange[0] && e <= r.hueRange[1]) return b[t];
          }
          return 'Color not found';
        }
        function u(e) {
          if (null === y) return Math.floor(e[0] + Math.random() * (e[1] + 1 - e[0]));
          var t = e[1] || 1,
            r = e[0] || 0;
          y = (9301 * y + 49297) % 233280;
          var n = y / 233280;
          return Math.floor(r + n * (t - r));
        }
        function f(e) {
          function t(e) {
            var t = e.toString(16);
        ...
        function c(e, t, r) {
          var n = r[0][0],
            ...
            i = r[r.length - 1][1],
            a = r[0][1];
          b[e] = { hueRange: t, lowerBounds: r, saturationRange: [n, o], brightnessRange: [i, a] };
        }
        function l(e) {
          var t = e[0];
          ...
          return [Math.floor(255 * f), Math.floor(255 * c), Math.floor(255 * l)];
        }
        function h(e) {
          (e = e.replace(/^#/, '')), (e = 3 === e.length ? e.replace(/(.)/g, '$1$1') : e);
          ...
          switch (o) {
            case t:
              return [(((r - n) / i) % 6) * 60 || 0, a, o];
            case r:
              return [60 * ((n - t) / i + 2) || 0, a, o];
            case n:
              return [60 * ((t - r) / i + 4) || 0, a, o];
          }
        }
        function d(e) {
          var t = e[0],
            ...
            n = e[2] / 100,
            o = (2 - r) * n;
          return [t, Math.round(r * n / (o < 1 ? o : 2 - o) * 1e4) / 100, o / 2 * 100];
        }
        function p(e) {
          for (var t = 0, r = 0; r !== e.length && !(t >= Number.MAX_SAFE_INTEGER); r++)
            t += e.charCodeAt(r);
          return t;
        }
        var y = null,
        ...
        var v = function(o) {
          if (
            ((o = o || {}), void 0 !== o.seed && null !== o.seed && o.seed === parseInt(o.seed, 10))
          )
            y = o.seed;
          else if ('string' === typeof o.seed) y = p(o.seed);
          else {
          ...
          if (null !== o.count && void 0 !== o.count) {
            var u = o.count,
              f = [];
            for (o.count = null; u > f.length; ) y && o.seed && (o.seed += 1), f.push(v(o));
            return (o.count = u), f;
          }
          return (i = e(o)), (a = t(i, o)), (s = r(i, a, o)), n([i, a, s], o);
        };
        return v;
      });
    }.call(t, r(11)(e)));
